...
@php
    ...
    // Filter pengumuman aktif saja (BR-LMS-07)
...
<div class="container-fluid px-2 px-md-4 py-3" style="max-width: 1000px;">
    ...
    <div class="border-bottom mb-4 bg-white sticky-top shadow-sm-mobile" style="top: 64px; z-index: 1020; margin-left: -8px; margin-right: -8px; padding-left: 8px; padding-right: 8px;">
        <ul class="nav nav-tabs gc-tabs border-0 flex-nowrap overflow-x-auto text-nowrap" id="classTab" role="tablist" style="-webkit-overflow-scrolling: touch; scrollbar-width: none;">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link px-3 py-2-5" id="schedule-tab" data-bs-toggle="tab" data-bs-target="#schedule-panel" type="button" role="tab">
                    Jadwal
                </button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-9">
                    <div class="d-flex flex-column gap-3">
                        ...
                        @if($isOwner)
                            <a href="{{ route('announcements.create', $class) }}" class="card border bg-white shadow-sm style-pointer text-decoration-none" style="border-radius: 8px;">
                                <div class="card-body p-3 d-flex align-items-center gap-3">
                                    ...
                                    <span class="text-secondary small">Umumkan sesuatu ke kelas Anda...</span>
                                </div>
                            </a>
                        @endif
        ...
        <div class="tab-pane fade" id="schedule-panel" role="tabpanel">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <h5 class="fw-medium mb-3">Jadwal Kelas</h5>

                    @php
                        $schedule = is_array($class->schedule_day) ? $class->schedule_day : json_decode($class->schedule_day, true);
                    @endphp
                    ...
                    @else
                        <div class="text-center py-4">
                            <i class="fas fa-calendar-times text-muted" style="font-size: 2.5rem;"></i>
                            <p class="text-muted mt-3 mb-0">Belum ada jadwal untuk kelas ini.</p>
                        </div>
                    @endif
                </div>
            </div>
